...
//Method cannot be called due to API limitations
...
router.get('/:city/forecast/:days', weatherController.getWeatherForcast);

//Get Historical data for a specific date (Date on or after 1st Jan, 2010 in yyyy-MM-dd format)
router.get('/:city/history/:date', weatherController.getPastWeather);

//Get Future data for a specific date (Date between 14 days and 300 days from today in the future in yyyy-MM-dd format) 
router.get('/:city/future/:date', weatherController.getFutureWeather);

//router.get('/:city/getAverageTemperature/:dateFrom/:dateTo', weatherController.getAverageTemperature);
...
//router.get('/:city/getMinimumTemperature/:date, weatherController.getMinimumTemperature);
